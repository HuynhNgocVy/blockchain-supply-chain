...
import Nav1 from '../../public/SVG/Nav1';
import Nav2 from '../../public/SVG/Nav2';
...
function Navbar() {
  ...
  return (
    <nav className={`bg-white pb-5 nd: text-sm ${
        state
    ...
    >
        <div className='gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8'>
            <div className="items-center justify-between py-5 md:block">
